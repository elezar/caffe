...
TYPED_TEST(SigmoidCrossEntropyLossLayerTest, TestForwardWithIgnoreLabelsNoMatch) {
  this->TestForward(-1);
}
...
TYPED_TEST(SigmoidCrossEntropyLossLayerTest, TestGradientWithIgnoreLabelsNoMatch) {
  this->TestGradient(-1);
}
